    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bmr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("        "+userid+" 님의 BMR(기초대사량) 지수\n                           "+session.getBMR()+" kcal");
        ...
        recommed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("권장 일일 운동 소모 칼로리 "+(session.getBMR()*0.2)+" kcal"+"\n\n하루 "+(session.getBMR()-(session.getBMR()*0.2))+" kcal 이하로 섭취시 체중감량");
