...
Context context;
    ...
    public RecipeAdapter(ArrayList<categoryitem> categories){
...
TextView recipe_text1,recipe_text2,recipe_text3;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recipeadapter, viewGroup, false);
